...
public class VoiceXsend {
    ...
    */
	 ...
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/voice/xsend
	 * https://api.submail.cn/voice/xsend
	 * http://api.submail.cn/voice/xsend
	 */
	...
	public static void main(String[] args) {
		 ...
		 * vars参数
		 * 例： vars.put("code", "123456"), 其中 code 对应模板中的 @var(code) 变量
		...
		/**
		 * http post 请求接口
		 * 成功返回 status: success,其中credits 参数为剩余语音余额
