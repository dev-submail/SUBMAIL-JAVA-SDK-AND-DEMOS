...
public class AdressbookMailSubscribe {
	/**
	 * 时间戳接口配置
	 */
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/addressbook/mail/subscribe";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/addressbook/message/unsubscribe
	 * https://api.submail.cn/addressbook/message/unsubscribe
	 * http://api.submail.cn/addressbook/message/unsubscribe
	 */
	...
	public static void main(String[] args) {
		 ...
		 * 请仔细阅读参数配置说明
		 * 
		 * 配置参数包括 appid, appkey ,target, signtype, 	address
		 * 用户参数设置，其中 appid, appkey, address, target为必须参数
		 * 请访问 submail 官网创建并获取 appid 和 appkey，链接：https://www.mysubmail.com/chs/mail/apps
		 * 其他具体参数请参考开发文档：https://www.mysubmail.com/chs/documents/developer/b2nqI3
