...
public class MobileDateCharge {
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/mobiledata/charge";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/mobiledata/charge
	 * https://api.submail.cn/mobiledata/charge
	 * http://api.submail.cn/mobiledata/charge
	 */
	...
	public static void main(String[] args) {
		...
		String cu="";
		String signtype = "";
//		String addressbook="contacts_addressbook";
