...
public class VoiceMultiXsend {
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/voice/multixsend";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/voice/multixsend
	 * https://api.submail.cn/voice/multixsend
	 * http://api.submail.cn/voice/multixsend
	 */
	...
	public static void main(String[] args) {
		...
		String signtype = "md5";
		//示例：添加一组数据
		toJSON.put("to", "176xxxxx");
		varsJSON.put("name", "xxx");
...
//	    }
		...
		/**
		 * http post 请求接口
		 * 成功返回 status: success,其中 money_account 参数为账户余额。
