...
public class AddressbookMailUnsubscribe {
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/addressbook/mail/unsubscribe";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/addressbook/mail/unsubscribe
	 * https://api.submail.cn/addressbook/mail/unsubscribe
	 * http://api.submail.cn/addressbook/mail/unsubscribe
	 */
	...
	public static void main(String[] args) {
		...
		String adress = "leo <leo@submail.cn>";
		String target = "";
		String signtype = "";
		/**
		 *  ---------------------------------------------------------------------------
