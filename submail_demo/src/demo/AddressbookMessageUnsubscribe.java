...
public class AddressbookMessageUnsubscribe {
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/addressbook/message/unsubscribe";
	/**
	 * 备用接口
	 * @param args
	...
	public static void main(String[] args) {
		 ...
		 * 请仔细阅读参数配置说明
		 * 
		 * 配置参数包括 appid, appkey ,to , signtype, target，timestamp，sign_type，signature
		 * 用户参数设置，其中 appid, appkey, sign_type, signature 为必须参数
