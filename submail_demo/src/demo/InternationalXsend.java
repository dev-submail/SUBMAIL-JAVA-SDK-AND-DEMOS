...
public class InternationalXsend {
	/**
	 * 时间戳接口配置
	 */
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/internationalsms/xsend";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/internationalsms/xsend
	 * https://api.submail.cn/internationalsms/xsend
	 * http://api.submail.cn/internationalsms/xsend
	 */
	...
	public static void main(String[] args) {
		 ...
		 * 请访问 submail 官网创建获取项目标识 project_id，https://www.mysubmail.com/chs/internationalsms/templates
		 * 如何获取项目标识 project 参数，链接：https://www.mysubmail.com/chs/documents/developer/jblWb
		 * vars参数
		...
		String to = "your_cellphone_number";
		String project = "your_project_id";
		String signtype = "";
		//vars.put("code", "123456");
		//vars.put("name", "submail");
		/**
		 *  ---------------------------------------------------------------------------
		 */
