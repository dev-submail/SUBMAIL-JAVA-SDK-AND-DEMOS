...
public class InternationalMultiXsend {
	/**
	 * 时间戳接口配置
	 */
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/internationalsms/multixsend";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/internationalsms/multixsend
	 * https://api.submail.cn/internationalsms/multixsend
	 * http://api.submail.cn/internationalsms/multixsend
	 */
	...
	public static void main(String[] args) {
		 ...
		 * 请访问 submail 官网创建获取项目标识 project_id，链接：https://www.mysubmail.com/chs/internationalsms/templates
		 * 如何获取项目标识 project 参数，链接：https://www.mysubmail.com/chs/documents/developer/4acOC
		 * multi参数
