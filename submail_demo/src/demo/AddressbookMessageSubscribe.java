...
public class AddressbookMessageSubscribe {
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/addressbook/message/subscribe";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/addressbook/message/subscribe
	 * https://api.submail.cn/addressbook/message/subscribe
	 * http://api.submail.cn/addressbook/message/subscribe
	 */
