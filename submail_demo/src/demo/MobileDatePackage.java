...
public class MobileDatePackage {
	/**
	 * 时间戳接口配置
	 */
    ...
    * API 请求接口配置
    */
	private static final String URL="https://api.mysubmail.com/mobiledata/package";
	/**
	 * 备用接口
	 * @param args
	 * http://api.mysubmail.com/mobiledata/package
	 * https://api.submail.cn/mobiledata/package
	 * http://api.submail.cn/mobiledata/package
	 */
	...
	public static void main(String[] args) {
		 ...
		 * 请仔细阅读参数配置说明
		 * 
		 * 配置参数包括 appid, appkey ,to, signtype, 
		 * appid, appkey, to,为必须参数
		 * 请访问 submail 官网创建并获取 appid 和 appkey，链接：https://www.mysubmail.com/chs/mobiledata/apps
		 * 如何获取手机流量单价明细，链接：https://www.mysubmail.com/chs/mobiledata/fee
		 * signtype 为可选参数: normal | md5 | sha1
		 * 当 signtype 参数为空时，默认为 normal
		 *  --------------------------------------------------------------------------
		 */
		String appid = "10195";
		String appkey = "c4b75bd20fb8ea3914ad0483ad234c4";
		String signtype = "";
		/**
		 *  ---------------------------------------------------------------------------
		 */
		...
		/**
		 * http post 请求接口
		 * 成功返回 status: success，credits 参数为剩余流量余额
